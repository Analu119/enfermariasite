...
<head>
    ...
    <meta name="author" content="Ana Luiza, Debora">
...
<div class="menu">
        <a href="index.php" >Cadastrar Pacientes </a>       
</div>
<div class="menu">           
...
<p>O <b>Setor de Assistência á Saúde</b> tem a missão de oferecer atenção básica à saúde para os alunos regularmente matriculados no IFTO, bem como os servidores,
     por meio de uma equipe multidisciplinar composta por duas enfermeiras e demais setores de assistência ao aluno, tendo em vista a promoção, proteção e recuperação da saúde dos estudantes, por meio de atendimentos
      ambulatoriais e encaminhamentos, tendo esse zelo em saúde.</p>
